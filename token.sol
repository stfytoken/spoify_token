...
Sponas is the currency for simple token transactions and smart contract execution, 
and it allows artists to receive payments from fans , 
gives them the opportunity to spend more time creating content and less time counting cents. 
Simply it's the currency of digital music.
*/
...
contract Sponas is Context, IERC20, Ownable {
    ...
    string private _name = "SPONAS";
    string private _symbol = "STFY";
    ...
    address payable public marketingAddress = 0x2D908397AcA8B9a052D4771446e86d623bb90E8E; // Marketing Address
    ...
    function totalLpBNB() public view returns (uint256) {
        // BNB has  18 decimals!
        return _tLpTotal;
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        _tLpTotal = _tLpTotal.add(address(this).balance);
